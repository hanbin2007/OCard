...
export const NOTICE_TITLES: Record<string, string> = {
  ...
  "task-lease-lost-outside-run": "租约被别的进程接管（任务未在运行）",
  "task-lease-left-behind-heartbeat-stuck": "任务租约可能留下了（心跳线程未退出）",
  "close-blocked-active-jobs": "有后台作业，已阻止关闭",
  ...
  "manifest-suspect-not-cleared": "任务已完成，但清单旁仍有「不可信」标记",
